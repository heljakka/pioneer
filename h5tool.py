...
# This file is not part of the Pioneer Networks, but it is necessary to produce the CelebA-HQ dataset properly
# for use outside Tensorflow.
# The file was adapted by Ari Heljakka to allow for creating training and testing datasets in separate H5 files
# and updated to support the Tensorflow version 1.8.0.
# All rights remain with the original copyright holder, NVIDIA CORPORATION.
...
def create_celeba_hq(h5_filename, celeba_dir, delta_dir, data_split, num_threads=4, num_tasks=100):
